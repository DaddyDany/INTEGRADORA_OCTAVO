...
public class Order {
    ...
    public Order(Long orderId, Date orderDate, String orderState, String orderPlace, Time orderTime, Float orderTotalPayment, Boolean orderPaymentState, String orderType, Integer orderTotalHours, CommonUser commonUser, List<OrderPackage> orderPackages) {
